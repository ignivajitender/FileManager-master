...
public class Constants {
    ...
    /**
     * A bundle key that can be used by external apps when triggering file picking from FAmaze.
     *
     * <p>This can be use as follows from an external app:</p>
     * <code>
     *  Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
     *  intent.setPackage("com.igniva.filemanager");
     *  intent.putExtra("com.igniva.filemanager.extra.TITLE", "Select the file...");
     *
     *  ... and then startActivityForResult
     * </code>
     *
     */
    public static final String FILE_PICKER_TITLE_BUNDLE_KEY = "com.igniva.filemanager.extra.TITLE";
